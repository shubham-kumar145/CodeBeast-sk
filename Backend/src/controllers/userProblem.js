...
// const createProblem = async (req, res) => {
//     const { StartCode, referenceSolution, title, description, difficulty, tags, visibletestcases, hiddentestcases } = req.body;

//     try {
//         for (const { language, completeCode } of referenceSolution) {

//             if (!completeCode) {
//                 return res.status(400).send(`Missing completeCode for ${language}`);
//             }
